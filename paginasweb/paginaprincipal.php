    ...
    <div class="row mt-4">
      <div class="col">
        <div class="p-4 bg-light text-center">
          ...
          <hr>
          <h3>Para ir directamente a nuestro taller lo puedes visitar o dar al primer boton el cual te llevara a donde nos ubicamos y un poco historia de nuestro taller.</h3
          <hr>
          <div>
