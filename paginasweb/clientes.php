...
<body>
  ...
  <section class="content">
    ...
    <div class="destaque-prod">
      ...
      if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["codCl"]) && isset($_POST["descripcion"]) && isset($_POST["direccion"]) && isset($_POST["apellidos"]) && isset($_POST["telefono"])) {
        $codCl = $_POST["codCl"];
        ...
        if ($checkResult->num_rows > 0) {
          ...
          $query = "INSERT INTO cliente (Cod_Cl, Descripcion, Direccion, Apellidos, Telefono) VALUES ('$codCl', '$descripcion', '$direccion', '$apellidos', '$telefono')";
